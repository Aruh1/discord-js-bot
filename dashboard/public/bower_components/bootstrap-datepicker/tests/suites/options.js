...
test("Autoclose", function () {
    var input = $("<input />").appendTo("#qunit-fixture").val("2012-03-05").datepicker({
            format: "yyyy-mm-dd",
            autoclose: true
        }),
...
test("Today Button: data-api", function () {
    var input = $('<input data-date-today-btn="true" />').appendTo("#qunit-fixture").val("2012-03-05").datepicker({
            format: "yyyy-mm-dd"
        }),
        dp = input.data("datepicker"),
        picker = dp.picker,
...
test("DaysOfWeekDisabled", function () {
    var input = $("<input />").appendTo("#qunit-fixture").val("2012-10-26").datepicker({
            format: "yyyy-mm-dd",
...
test("Picker is shown on input focus when showOnFocus is not defined", function () {
    var input = $("<input />").appendTo("#qunit-fixture").val("2014-01-01").datepicker({}),
        dp = input.data("datepicker"),
        picker = dp.picker;
...
test("Container", function () {
    var testContainer = $('<div class="date-picker-container"/>').appendTo("#qunit-fixture"),
        input = $("<input />")
            .appendTo("#qunit-fixture")
            .val("2012-10-26")
            .datepicker({
...
test("forceParse: false on enter on invalid date", function () {
    var input = $("<input />").appendTo("#qunit-fixture").val("123456789").datepicker({ forceParse: false }).focus();
...
test("Enable on readonly options (default)", function () {
    var input = $('<input readonly="readonly" />').appendTo("#qunit-fixture").datepicker({ format: "dd-mm-yyyy" }),
        dp = input.data("datepicker"),
        picker = dp.picker;
...
test("Enable on readonly options (false)", function () {
    var input = $('<input readonly="readonly" />').appendTo("#qunit-fixture").datepicker({
            format: "dd-mm-yyyy",
...
test(
    ...
    patch_date(function (Date) {
        var input = $("<input />").appendTo("#qunit-fixture").val("2015年04月21日").datepicker({
                language: "zh-CN"
            }),
            dp = input.data("datepicker"),
            picker = dp.picker;
...
test(
    ...
    patch_date(function (Date) {
        var input = $("<input />").appendTo("#qunit-fixture").val("04/21/2015").datepicker({
                language: "aa-BB"
            }),
            dp = input.data("datepicker"),
            picker = dp.picker;
...
test("Visibility of the prev and next arrows for year/decade/century/millenium views with startDate and endDate", function () {
    var input = $("<input />").appendTo("#qunit-fixture").val("01/01/2015").datepicker({
            format: "dd/mm/yyyy",
            startView: 1,

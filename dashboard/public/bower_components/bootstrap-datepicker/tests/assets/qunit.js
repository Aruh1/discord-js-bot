...
(function (window) {
    ...
    extend(QUnit, {
        ...
        push: function (result, actual, expected, message) {
            ...
            if (!result) {
                ...
                output +=
                    '<table><tr class="test-expected"><th>Expected: </th><td><pre>' + expected + "</pre></td></tr>";
                if (actual != expected) {
    ...
    function id(name) {
        return (
            !!(typeof document !== "undefined" && document && document.getElementById) && document.getElementById(name)
        );
    }

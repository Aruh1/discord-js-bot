        ...
        function isValid(pos, c, strict, fromSetValid, fromAlternate, validateOnly) {
            ...
            function setValidPosition(pos, validTest, fromSetValid, isSelection) {
                if (
                    ...
                    if (!valid)
                        return (getMaskSet().validPositions = $.extend(!0, {}, positionsClone)), resetMaskSet(!0), !1;
                                                            ...
                                                            for (var i = 0; i < tll; i++) {
                                                                if (
                                                                    ...
                                                                    targetAI - bestMatchAI >
                                                                        Math.abs(targetAI - tstAI) && (bestMatch = tst);
                                                                    break;
                                                                }
        ...
        function caret(input, begin, end, notranslate) {
            ...
            if ((begin.begin !== undefined && ((end = begin.end), (begin = begin.begin)), "number" == typeof begin)) {
                ...
                if (
                    ...
                    if (
                        ((range = document.createRange()), input.firstChild === undefined || null === input.firstChild)
                    ) {
        ...
        if (actionObj !== undefined)
            switch (actionObj.action) {
                ...
                case "isValid":
                    ...
                    return (
                        buffer.splice(rl, lmib + 1 - rl), isComplete(buffer) && actionObj.value === getBuffer().join("")
                    );

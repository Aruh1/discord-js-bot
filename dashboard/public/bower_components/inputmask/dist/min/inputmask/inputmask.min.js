...
!(function (e) {
    ...
    function s(r, o, l) {
                                                    ...
                                                    T.alternation === B.alternation &&
                                                        ...
                                                        -1 ===
                                                            ...
                                                            (T.na =
                                                                T.na +
                                                                "," +
                                                                T.locator[B.alternation].toString().split("")[0]),
                                                        (G = !0),
                                                        (T.locator[T.alternation] =
                                                            B.locator[B.alternation].toString().split("")[0] +
                                                            "," +
        ...
        function N(e) {
            ...
            for (
                ;
                (t = m().validPositions[n - 1]) && t && t.match.optionality && t.input === l.skipOptionalPartCharacter;
                        ...
                        (t.ctrlKey &&
                            ...
                            !(function (e) {
                                var t = n.createElement("input"),
                                    ...
                                    a = i in t;
                                return (
                                    a || (t.setAttribute(i, "return;"), (a = "function" == typeof t[i])), (t = null), a
                                );
                            })("cut"))
                    )
                        t.preventDefault(),
                ...
                function c(n, a, o, s) {
                    ...
                    if (!0 === a.importDataAttributes) {
                        ...
                        if (
                            (h &&
                                "" !== h &&
                                ((h = h.replace(new RegExp("'", "g"), '"')), (u = JSON.parse("{" + h + "}"))),
                            u)
                        ) {
                            f = i;
                            for (p in u)

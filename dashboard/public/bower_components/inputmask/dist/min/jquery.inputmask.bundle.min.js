                    ...
                    return (
                        i.prototype.masksCache[u] === a || !0 === n
                            ? ((c = {
                              ...
                              !0 !== n &&
                                  ((i.prototype.masksCache[u] = c), (c = e.extend(!0, {}, i.prototype.masksCache[u]))))
                        ...
                        function c(n, i, o, s) {
                            if (!0 === i.importDataAttributes) {
                                ...
                                if (
                                    (d &&
                                        "" !== d &&
                                        ((d = d.replace(new RegExp("'", "g"), '"')), (c = JSON.parse("{" + d + "}"))),
                                    c)
                                ) {
                                    u = a;
                                    for (p in c)
                ...
                t.extendAliases({
                    numeric: {
                        ...
                        canClearPosition: function (e, t, n, a, i) {
                            ...
                            return (
                                !o || ("+" !== r.match.nativeDef && "-" !== r.match.nativeDef) || (i.isNegative = !1), o
                            );
                        },
                        onKeyDown: function (n, a, i, r) {
                            var o = e(this);

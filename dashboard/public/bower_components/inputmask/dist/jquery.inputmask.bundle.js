                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        if ((validatedPos = rslt.pos !== undefined ? rslt.pos : position) !== position)
                                            return (
                                                (rslt = $.extend(rslt, isValid(validatedPos, elem, !0, fromSetValid))),
                                                !1
                                            );
                                    } else if (
                                        !0 !== rslt &&
            ...
            return (
                (Inputmask.prototype = {
                    ...
                    defaults: {
                        ...
                        ignorables: [
                            8, 9, 13, 19, 27, 33, 34, 35, 36, 37, 38, 39, 40, 45, 46, 93, 112, 113, 114, 115, 116, 117,
                                    ...
                                    if (!0 === isValid) {
                                        if (
                                            ...
                                            for (
                                                ...
                                                null ===
                                                processValue.match(Inputmask.escapeRegex(bufferTemplate) + "$");

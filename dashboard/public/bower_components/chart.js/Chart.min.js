        ...
        (e.RadialScale = e.Element.extend({
            ...
            setScaleSize: function () {
                var t,
                    ...
                    g = 0;
                for (
                    this.ctx.font = W(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily),
                        i = 0;
                    i < this.valuesCount;
                    i++
                )
    ...
    function () {
        ...
        i.Type.extend({
            ...
            initialize: function (t) {
                (this.segments = []),
                    (this.outerRadius =
                        (e.min([this.chart.width, this.chart.height]) - this.options.segmentStrokeWidth / 2) / 2),

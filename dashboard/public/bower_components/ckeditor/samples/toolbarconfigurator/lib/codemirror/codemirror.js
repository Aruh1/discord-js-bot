(function (q) {
    ...
    function cd(a, b, c, d) {
        ...
        if ("page" == d || "window" == d)
            (a = a.display.lineSpace.getBoundingClientRect()),
                (b +=
                    a.top +
                    ("window" == d ? 0 : window.pageYOffset || (document.documentElement || document.body).scrollTop)),
                (d =
                    a.left +
    ...
    function rd(a, b, c, d, e) {
        function f(b) {
            ...
            if (null == d) {
                if ((b = !b))
                    (b = g + c), b < a.first || b >= a.first + a.size ? (b = m = !1) : ((g = b), (b = l = u(a, b)));
    ...
    function Aa(a, b) {
        ...
        if (c)
            for (var e, f = 0; f < c.length; ++f)
                (e = c[f]),
                    e.marker.collapsed && null == (b ? e.from : e.to) && (!d || 0 > Ve(d, e.marker)) && (d = e.marker);
        return d;
    }

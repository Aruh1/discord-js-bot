...
Object.defineProperty &&
        ...
        return (
            ...
            (n.prototype = {
                ...
                deprecationNotice: function (a, b) {
                    H.warn(
                        "DEPRECATED: " + a + " in module " + this.name + "is deprecated. Please use " + b + " instead"
                    );
                },
                ...
                : (a(document, "addEventListener") && document.addEventListener("DOMContentLoaded", v, !1),
                  ...
                  H.createCoreModule("WrappedRange", ["DomRange"], function (a, b) {
                      ...
                      a.features.implementsDomRange &&
                          ...
                          (a.createIframeRange = function (c) {
                              return (
                                  b.deprecationNotice("createIframeRange()", "createRange(iframeEl)"), a.createRange(c)
                              );
                          }),
                  ...
                  H.createCoreModule("WrappedSelection", ["DomRange", "WrappedRange"], function (a, b) {
                      ...
                      function g(a) {
                          ...
                          return (
                              a.anchorNode &&
                                  (b = 1 == A.comparePoints(a.anchorNode, a.anchorOffset, a.focusNode, a.focusOffset)),
                              b
                          );
                      }
                      function h(a, b, c) {
    ...
    (wysihtml5.lang.Dispatcher = Base.extend({
        on: function (a, b) {
            return (
                (this.events = this.events || {}), (this.events[a] = this.events[a] || []), this.events[a].push(b), this
            );
        },
        off: function (a, b) {
    ...
    (function (a) {
        ...
        a.dom.ContentEditableArea = Base.extend({
            ...
            _bindElement: function (a) {
                return (
                    (a.className =
                        a.className && "" != a.className ? a.className + " wysihtml5-sandbox" : "wysihtml5-sandbox"),
        ...
        tryToPullLiLevel: function (a, b) {
            ...
            return (
                b.selection.executeAndRestoreRangy(function () {
                    ...
                    for (j = a.length; j--; )
                        if (
                            ((f = a[j]), f.parentNode && ((c = f.parentNode), "OL" === c.tagName || "UL" === c.tagName))
                        ) {
                            if (
                                ((h = !0),
